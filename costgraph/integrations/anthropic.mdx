...
<Card title="Anthropic reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/anthropic">
...
4. Run the exporter with `--provider anthropic`, following the
   [Anthropic reference](https://docs.costgraph.ai/costgraph/focus-exporter/anthropic) for the environment it needs.
