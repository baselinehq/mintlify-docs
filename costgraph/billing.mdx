...
For detailed pricing and to choose a plan, visit our [pricing page](https://costgraph.ai/pricing).
...
Billing is set up and managed in the CostGraph dashboard, with subscriptions handled securely through Stripe. To manage your plan and payment method, visit your [billing settings](https://app.costgraph.ai/settings/account/billing).
