...
### Providers
The providers endpoint (`/providers`) returns a list of all supported cloud providers, regions, services, and usage types (e.g.: spot_preemptible, ondemand, reserved). All values are now case-insensitive and returned in lower case.