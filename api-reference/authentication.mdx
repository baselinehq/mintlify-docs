...
Create an account on [costgraph.baselinehq.cloud](https://costgraph.baselinehq.cloud/) to obtain your API key.
...
curl -H "X-API-KEY: $COSTGRAPH_API_KEY" \
     ...
     -X POST https://pricing.baselinehq.cloud/v1/compute/pricing \
