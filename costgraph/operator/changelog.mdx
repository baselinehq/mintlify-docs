...
<Update label="2026-08-11" description="costgraph-operator v0.2.3">
    ...
    ### Updates
    - Added a Daemonset-based, root-priveleged BPF network-flow tracing agent that runs on compatible nodes across the fleet. Compatible nodes must expose a host-mounted cgroup v2 filesystem and run a BTF-enabled kernel for the fentry programs.
