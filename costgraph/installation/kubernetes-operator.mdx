...
To run the CostGraph operator, you will need to create an account on [costgraph.baselinehq.cloud](https://costgraph.baselinehq.cloud/) to obtain an [API key](https://costgraph.baselinehq.cloud/dashboard/api-keys).
...
<Tabs>
  ...
  <Tab title="Grafana Dashboard">
    Once you have the operator running, you can install the Grafana dashboard to view the metrics in a more user-friendly format. The Grafana dashboard is available in the [costgraph-manifests](https://github.com/baselinehq/costgraph-manifests/tree/main/grafana) repository.
