...
<CardGroup cols={2}>
  ...
  <Card title="MCP and the agent" icon="plug" href="/costgraph/mcp/install">
    Ask about any connected provider from your editor or from chat. Needs an active
    billing plan.
  </Card>
</CardGroup>
