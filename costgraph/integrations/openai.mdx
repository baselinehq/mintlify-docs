...
<Card title="OpenAI reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/openai">
...
4. Run the exporter with `--provider openai`, following the
   [OpenAI reference](https://docs.costgraph.ai/costgraph/focus-exporter/openai) for the environment it needs.
