...
### Providers
The providers endpoint (`/providers`) returns a list of all supported cloud providers, regions,services and usage types ( e.g: SPOT_PREEMPTIBLE,ONDEMAND,RESERVED)