...
CostGraph turns the metrics your [agent](/costgraph/agent) collects into per-VM recommendations: downsize, upsize, terminate, or leave as-is. The engine is deliberately **conservative** — capacity safety always beats savings, and weak or contradictory evidence produces *no* recommendation rather than a guess.
...
- **Idle window** — a longer **7-day** window, since terminating a VM demands stronger evidence.
