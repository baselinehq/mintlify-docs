    ...
    <ParamField body="config" type="object">
      ...
      <Expandable title="Config Properties">
        ...
        <ParamField body="worker_count" type="number">
          ...
          <ParamField body="reconcile_time" type="string">
              Duration style string for how often to reconcile recommendations. Default is `5m`
          </ParamField>
        ...
        <ParamField body="costgraph_feature_flags" type="object">
          ...
          <Expandable title="Feature Flags Properties">
            ...
            <ParamField body="prometheus" type="boolean">
              ...
              <ParamField body="disable_iqr" type="boolean">
                  Disable IQR filtering. Default is `false`
              </ParamField>
          </Expandable>
        </ParamField>
