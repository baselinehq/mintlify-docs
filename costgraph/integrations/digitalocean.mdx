...
<Card title="DigitalOcean reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/digitalocean">
...
4. Run the exporter with `--provider digitalocean`, following the
   [DigitalOcean reference](https://docs.costgraph.ai/costgraph/focus-exporter/digitalocean) for the environment it needs.
