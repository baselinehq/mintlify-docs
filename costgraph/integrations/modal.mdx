...
<Card title="Modal reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/modal">
...
4. Run the exporter with `--provider modal`, following the
   [Modal reference](https://docs.costgraph.ai/costgraph/focus-exporter/modal) for the environment it needs.
