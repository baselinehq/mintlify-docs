...
Connect the providers you pay and CostGraph puts all of that spend in one view. Cost
Overview, anomaly detection, recommendations, and the MCP tools work the same whether
the charge came from AWS, an LLM gateway, or a Kafka cluster.

<CardGroup cols={3}>
  <Card title="22 providers" icon="plug">
    Hyperscalers, IaaS, databases, AI, and SaaS, side by side.
  </Card>
