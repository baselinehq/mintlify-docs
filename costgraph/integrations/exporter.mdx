...
<Note>
**Self-hosted CostGraph**: the exporter pushes to `https://api.costgraph.ai` by
default. Point it at your own install with `COSTGRAPH_URL` - set it the same
way as any other setting (flag, config file, or environment variable), to your
