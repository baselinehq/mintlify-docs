...
<CardGroup cols={3}>
  <Card title="Amazon Web Services" icon="/images/logos/aws.svg" href="/costgraph/integrations/pull/aws">
    Your AWS bill, down to the resource.
  </Card>
  <Card title="Google Cloud" icon="/images/logos/gcp.svg" href="/costgraph/integrations/pull/gcp">
    Your Google Cloud bill, down to the resource.
  </Card>
  <Card title="DigitalOcean" icon="/images/logos/digitalocean.svg" href="/costgraph/integrations/pull/digitalocean">
    Droplets, volumes, load balancers, databases, spaces.
  </Card>
  <Card title="OVHcloud" icon="/images/logos/ovhcloud.svg" href="/costgraph/integrations/pull/ovhcloud">
    Every product on the bill, with Public Cloud usage per project.
  </Card>
  <Card title="STACKIT" icon="/images/logos/stackit.svg" href="/costgraph/integrations/pull/stackit">
    Managed services, attributed per project.
  </Card>
  <Card title="Scaleway" icon="/images/logos/scaleway.svg" href="/costgraph/integrations/pull/scaleway">
    Per project and per resource.
  </Card>
  <Card title="Akamai Cloud (Linode)" icon="/images/logos/linode.svg" href="/costgraph/integrations/pull/linode">
    Every line item on the invoice.
  </Card>
  <Card title="Cherry Servers" icon="/images/logos/cherryservers.svg" href="/costgraph/integrations/pull/cherryservers">
    Bare metal, priced per server.
  </Card>
  <Card title="Vercel" icon="/images/logos/vercel.svg" href="/costgraph/integrations/pull/vercel">
    Team spend, split by project.
  </Card>
  <Card title="Modal" icon="/images/logos/modal.svg" href="/costgraph/integrations/pull/modal">
    Serverless GPU and compute, per function.
  </Card>
  <Card title="RunPod" icon="/images/logos/runpod.svg" href="/costgraph/integrations/pull/runpod">
    GPU pods and serverless, per GPU type.
  </Card>
  <Card title="Depot" icon="/images/logos/depot.svg" href="/costgraph/integrations/pull/depot">
    Container build and runner minutes, with cache savings.
  </Card>
  <Card title="Daytona" icon="/images/logos/daytona.svg" href="/costgraph/integrations/pull/daytona">
...
<CardGroup cols={3}>
  <Card title="Anthropic" icon="/images/logos/anthropic.svg" href="/costgraph/integrations/pull/anthropic">
    Spend per model.
  </Card>
  <Card title="OpenAI" icon="/images/logos/openai.svg" href="/costgraph/integrations/pull/openai">
    Spend per model.
  </Card>
  <Card title="OpenRouter" icon="/images/logos/openrouter.svg" href="/costgraph/integrations/pull/openrouter">
    One connection covers every model you route through it.
  </Card>
  <Card title="Helicone" icon="/images/logos/helicone.svg" href="/costgraph/integrations/pull/helicone">
    Gateway spend across every upstream provider.
  </Card>
  <Card title="RespanAI" icon="shuffle" href="/costgraph/integrations/pull/respanai">
    Request spend across every routed model.
  </Card>
  <Card title="Cursor" icon="/images/logos/cursor.svg" href="/costgraph/integrations/pull/cursor">
    Team usage, per model and per member.
  </Card>
  <Card title="xAI" icon="/images/logos/xai.svg" href="/costgraph/integrations/pull/xai">
    Grok spend per model.
  </Card>
  <Card title="LiteLLM" icon="/images/logos/litellm.svg" href="/costgraph/integrations/pull/litellm">
    Gateway spend per key, model, and team.
  </Card>
  <Card title="TrueFoundry" icon="/images/logos/truefoundry.svg" href="/costgraph/integrations/pull/truefoundry">
    Enterprise LLM gateway spend, per model, with cache savings.
  </Card>
  <Card title="New API" icon="/images/logos/newapi.svg" href="/costgraph/integrations/pull/newapi">
    Self-hosted LLM gateway spend, per model and key.
  </Card>
  <Card title="AI gateways" icon="/images/logos/agentgateway.svg" href="/costgraph/integrations/pull/ai-gateways">
    Token usage from Envoy AI Gateway, agentgateway, APISIX, and vLLM, priced by us.
  </Card>
  <Card title="ElevenLabs" icon="/images/logos/elevenlabs.svg" href="/costgraph/integrations/pull/elevenlabs">
...
<CardGroup cols={3}>
  ...
  <Card title="PlanetScale" icon="/images/logos/planetscale.svg" href="/costgraph/integrations/pull/planetscale">
    Database spend, plus rightsizing for the databases behind it.
  </Card>
  <Card title="Redis Cloud" icon="/images/logos/rediscloud.svg" href="/costgraph/integrations/pull/rediscloud">
    Per subscription and per database.
  </Card>
  <Card title="ClickHouse" icon="/images/logos/clickhouse.svg" href="/costgraph/integrations/pull/clickhouse">
...
<CardGroup cols={3}>
  <Card title="Confluent Cloud" icon="/images/logos/confluent.svg" href="/costgraph/integrations/pull/confluent">
...
<CardGroup cols={3}>
  <Card title="GitHub" icon="/images/logos/github.svg" href="/costgraph/integrations/pull/github">
    Actions minutes, Packages storage, Copilot seats.
  </Card>
  <Card title="Blacksmith" icon="/images/logos/blacksmith.svg" href="/costgraph/integrations/pull/blacksmith">
    GitHub Actions runner minutes, per runner size.
  </Card>
  <Card title="Buildkite" icon="/images/logos/buildkite.svg" href="/costgraph/integrations/pull/buildkite">
    CI seats, with idle-seat signals.
  </Card>
  <Card title="Hatchet" icon="/images/logos/hatchet.svg" href="/costgraph/integrations/pull/hatchet">
...
<CardGroup cols={3}>
  <Card title="Cloudflare" icon="/images/logos/cloudflare.svg" href="/costgraph/integrations/pull/cloudflare">
...
<CardGroup cols={3}>
  <Card title="Datadog" icon="/images/logos/datadog.svg" href="/costgraph/integrations/pull/datadog">
    What Datadog itself costs you, by product.
  </Card>
  <Card title="Grafana Cloud" icon="/images/logos/grafanacloud.svg" href="/costgraph/integrations/pull/grafanacloud">
    Metrics, logs, traces, and profiles per stack.
  </Card>
  <Card title="CostGraph" icon="/images/logos/costgraph.svg" href="/costgraph/integrations/pull/costgraph">
