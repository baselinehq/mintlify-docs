...
<Card title="Grafana Cloud reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/grafanacloud">
  The credentials and permissions Grafana Cloud needs, every environment variable, the
...
4. Run the exporter with `--provider grafanacloud`, following the
   [Grafana Cloud reference](https://docs.costgraph.ai/costgraph/focus-exporter/grafanacloud) for the environment it needs.
