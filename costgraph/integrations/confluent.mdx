...
<Card title="Confluent Cloud reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/confluent">
...
4. Run the exporter with `--provider confluent`, following the
   [Confluent Cloud reference](https://docs.costgraph.ai/costgraph/focus-exporter/confluent) for the environment it needs.
