...
<ParamField body="--flowtrace-host-cgroup-fs" type="string" default="/host/sys/fs/cgroup">
  Directory for host cgroup filesystem. If `/host/sys/fs/cgroup` does not exist, `/sys/fs/cgroup` is used instead.
</ParamField>
