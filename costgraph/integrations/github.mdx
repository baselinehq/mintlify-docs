...
<Card title="GitHub reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/github">
...
4. Run the exporter with `--provider github`, following the
   [GitHub reference](https://docs.costgraph.ai/costgraph/focus-exporter/github) for the environment it needs.
