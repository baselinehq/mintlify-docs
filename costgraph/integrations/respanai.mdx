...
- In Respan AI, create an API key.
- Note an organization id. The logs API returns no account id, so CostGraph uses what
  you enter as the billing account.

## Let CostGraph pull

1. Open **Settings > Integrations** and pick **RespanAI**.
2. Name the connection and pick the tenant these charges belong to.
3. Enter the values you copied. The form lists what RespanAI needs and marks the
   optional ones.
4. Select **Connect**.
