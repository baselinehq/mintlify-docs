...
![Dashboard](https://github.com/baselinehq/mintlify-docs/blob/main/images/dashboard.gif?raw=true)

## Advanced Configuration

For the full list of values supported by the CostGraph Operator Helm chart (all `values.yaml` options), see the [Kubernetes configuration reference](/costgraph/configuration/kubernetes).
