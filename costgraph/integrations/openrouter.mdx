...
<Card title="OpenRouter reference" icon="book" href="https://docs.costgraph.ai/costgraph/focus-exporter/openrouter">
...
4. Run the exporter with `--provider openrouter`, following the
   [OpenRouter reference](https://docs.costgraph.ai/costgraph/focus-exporter/openrouter) for the environment it needs.
