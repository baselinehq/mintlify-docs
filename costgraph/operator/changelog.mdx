...
<Update label="2026-09-26" description="costgraph-operator v0.7.2">
    ...
    - **New accelerator exporter, shipped off by default.** A DaemonSet attributes per-process accelerator usage to the pod and container that owns it, and serves those metrics on port `9405`. Turn it on with:
