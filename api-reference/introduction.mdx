...
The API is versioned under `/v1`. The unprefixed routes from earlier releases still work and are marked deprecated in the reference below; they keep their original response shapes. New callers should use `/v1` throughout.
