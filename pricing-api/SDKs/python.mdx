...
The Python client is not on PyPI. Install it from the public repository, pinned to a release tag (tags are cut by release; omit `@v1.0.0` for the default branch):
