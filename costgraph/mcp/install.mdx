...
Grab an API key from [costgraph.baselinehq.cloud](https://costgraph.baselinehq.cloud), then point your agent at the endpoint below.

```text
https://costgraph.ai/mcp
...
<Tabs>
  ...
  <Tab title="Claude" icon="/images/mcp/claude.svg">
    ...
    ```bash
    claude mcp add --transport http costgraph https://costgraph.ai/mcp \
